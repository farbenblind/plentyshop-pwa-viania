<template>
  <component
    ...
    :disabled="disabled"
    :class="[
      'inline-flex items-center justify-center font-light text-base focus-visible:outline focus-visible:outline-offset rounded-md disabled:text-disabled-500 disabled:bg-disabled-300 disabled:shadow-none disabled:ring-0 disabled:cursor-not-allowed',
      sizeClasses,
...
export const variantClasses = {
  [SfButtonVariant.primary]:
    'text-white shadow hover:shadow-md active:shadow bg-black-500 hover:bg-primary-600 active:bg-primary-700 disabled:bg-disabled-300',
