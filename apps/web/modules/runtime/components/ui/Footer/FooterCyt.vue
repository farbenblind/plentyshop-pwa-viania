    ...
    <div class="max-w-screen-3xl mx-auto py-[40px] px-[20px] text-[14px] xl:py-[60px]">
      <div class="xl:grid xl:grid-cols-[auto_1fr_auto] xl:gap-[100px]">
        <div class="text-center xl:text-left">
          <p class="hl font-semibold xl:text-[18px]">
            {{ t('Footer.Fragen1') }}
            <template v-if="viewport.isLessThan('lg')">&nbsp;{{ t('Footer.Fragen2') }}</template>
          </p>
        ...
        <div class="pt-[40px] max-w-[900px] mx-auto xl:pt-[0] xl:flex xl:gap-[60px] xl:flex xl:justify-between w-full xl:max-w-[530px]">
          ...
          <div class="links flex flex-col">
            ...
            <ul class="pb-[20px] leading-[2] xl:pb-[0]">
              ...
              <li><NuxtLink :to="localePath(paths.cancellationForm)">{{ t('legal.cancellationForm') }}</NuxtLink></li>
      ...
      <div class="mini-links xl:hidden text-center gap-[10px] flex flex-wrap pt-[40px] justify-center">
        ...
        <NuxtLink :to="localePath(paths.cancellationForm)">{{ t('legal.cancellationForm') }}</NuxtLink>
