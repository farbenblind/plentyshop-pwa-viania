<template>
    ...
    >
      ...
      <div class="grid grid-cols-[auto_55px] pt-[15px] xl:grid-cols-[auto_80px]">
        <div class="prices-badge">
          ...
          <div class="text-[12px]">
            ...
            <i18n-t keypath="shipping.excludedLabel" scope="global">
              <template #shipping>
                <SfLink :href="localePath('/versandkosten')" target="_blank" class="focus:outline focus:outline-offset-2 focus:outline-2 outline-secondary-600 rounded">{{ $t('common.labels.delivery') }}</SfLink>
              </template>
            </i18n-t>
          </div>
        ...
        <div v-if="oekotex" class="flex items-center justify-center mb-[-20px]">
      ...
      <div class="pt-[35px]">
        ...
        <details v-if="material" class="group border-t border-b mt-[-1px] border-black py-[12px] xl:py-[15px]">
          ...
          <div v-html="material" class="mt-4 leading-relaxed text-[14px] [&_ul]:mb-5 [&_ul]:mt-1"/>
        </details>
